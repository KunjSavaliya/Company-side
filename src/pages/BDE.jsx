            ...
            <section className="breadcrumb bg-gradient-to-r from-[#0c4393] to-[#2780d4]  pt-48 pb-16 ">
                <div className="container mx-auto relative ">
                    <div className="max-w-screen-2xl mx-auto">
                        <h2 className="text-white font-semibold text-2xl mb-3"> Business Devlopment Executive</h2>
                    ...
                    <div className="max-w-screen-2xl mx-auto flex">
                        <div className="w-full p-4 mx-auto md:w-3/4">
                            <div className="about_details mb-4">
                                ...
                                <p className='color_grey text-base font-normal pb-2'>SIPL Technologies is seeking a creative Business Development Executive in the IT Sector to create and implement
                                ...
                                <p className='color_grey text-base font-normal pb-2'>Finally, a top-notch business development executive will pay close
